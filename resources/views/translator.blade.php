    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            color: var(--text);
            background: radial-gradient(1000px 500px at 100% 0%, rgba(99, 102, 241, 0.16), transparent 60%), var(--bg);
        }
        ...
        /* Ensure small user pill / login area align */
        .nav>div {
            display: flex;
            align-items: center;
            gap: 10px;
...
<body>
    <div class="container">
        <div class="nav">
            <a class="brand"><span class="logo"><i class="fas fa-language"></i></span><span>Language Translator</span></a>
            <div style="display:flex; align-items:center; gap:10px;">
                <a href="/" class="btn btn-ghost" style="padding:8px 12px; color:#e5e7eb; border-color:rgba(148,163,184,0.5);"><i class="fas fa-home"></i> Home</a>
                <span class="pill" id="userPill" title="User" style="display:none;"><i class="fas fa-user"></i> <span id="userName"></span></span>
                <a href="/login" id="loginBtn" class="btn" style="display:none;"><i class="fas fa-sign-in-alt"></i> Login</a>
